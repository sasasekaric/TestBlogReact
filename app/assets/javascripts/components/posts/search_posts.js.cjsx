...
@SearchPosts = React.createClass
  ...
  render: ->
    <form id="searchForm" className="searchForm form" ref='searchPostsForm'  >
      <div className="row">
        <div className="form-group col-xs-12 col-md-8 col-lg-6 col-md-offset-2 col-lg-offset-3">
          <input className="form-control" name="searchInput" onKeyUp={@handleSearch} type="text" placeholder="Search posts by title" ref='searchQuery'  />
        </div>
      </div>
    </form>
